...
const UploadModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-900 rounded-2xl max-w-lg w-full shadow-2xl border border-slate-200/90 dark:border-slate-800 overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        {/* Modal Header */}
          ...
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-white font-heading">
                Upload & Ingest Medical Document
              </h3>
              <p className="text-[11px] text-slate-400">Automated OCR and SHA-256 integrity vault</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div
            ...
            className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition-all ${
              isDragging
                ...
                : 'border-slate-200 dark:border-slate-700 hover:border-teal-500 hover:bg-slate-50 dark:hover:bg-slate-800/40'
            }`}
          >
            <input
              type="file"
            ...
            {file ? (
              ...
              <div>
                ...
                <p className="text-xs font-bold text-slate-700 dark:text-slate-300">
                  Click to browse or drag & drop medical file
                </p>
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                placeholder="e.g. Comprehensive Metabolic Panel - Apollo"
          ...
          <div className="pt-2 flex items-center justify-end space-x-2.5">
            ...
            <button
              ...
              className="inline-flex items-center space-x-2 px-5 py-2 bg-teal-600 hover:bg-teal-700 disabled:opacity-50 text-white text-xs font-bold rounded-xl shadow-xs transition-all active:scale-95"
            >
              {isUploading ? (
                <>
